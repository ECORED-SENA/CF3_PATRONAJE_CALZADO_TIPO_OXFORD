        ...
        .row.mb-5
          ...
          .col-lg-7.order-lg-1
            ...
            .bg-color-7.p-4(data-aos="fade-left")
              p.mb-0 Inicialmente considerado un zapato informal, el Oxford fue evolucionando hasta convertirse en un símbolo de elegancia y distinción, especialmente en el vestir masculino. Su característica principal es el sistema de cordones cerrados, esto le confiere una apariencia ajustada, sobria y refinada, diferenciándolo de otros estilos de calzado. 
        .row.mb-5
